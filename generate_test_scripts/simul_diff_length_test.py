...
outfile = open("test_files/simul_diff_length_test.txt", 'w')
j = 0
    
# c1 d2
for i in range(0, 128):
    outfile.write(f"{j},0:2,1:0,2:2,3:0,4:0,5:0,6:0,7:0,8:0,9:0,10:0,11:0,12:0,13:0,14:0\n")
    j += 1

# d2
for i in range(0, 128):
    outfile.write(f"{j},0:0,1:0,2:2,3:0,4:0,5:0,6:0,7:0,8:0,9:0,10:0,11:0,12:0,13:0,14:0\n")
    j += 1
...
# A 16 D 16
for i in range(0, 8):
    outfile.write(f"{j},0:0,1:0,2:3,3:0,4:0,5:0,6:0,7:2,8:0,9:0,10:0,11:0,12:0,13:0,14:0\n")
    j += 1
